...
If Request.Form.Count > 0 Then	
	...
	End Function	
	if Request.Form("submit") = "Modify Optional Links" then
...
'Response.End	
    if Request.Form("submit") = "View Reports" then
		connSWPPP.Close
...
<form id="theForm" method="post" action="<% = Request.ServerVariables("script_name") %>" onsubmit="return isReady(this)";>
	...
	<center><input type="button" style="font-size: 20px;" value="Delete Report" onclick="location='deleteReport.asp?inspecID=<% = inspecID %>'; return false;"/></center><br/><br/>
...
<!-- ------------- Optional Links ----------------------------------------------------- -->
<hr/>
<center><input name="submit" type="submit" style="font-size: 20px;" value="Modify Optional Links"/></center>
<hr/>
<center><input name="submit" type="submit" style="font-size: 20px;" value="View Reports"/></center>
...
'Else
	...
	<tr>
		...
		<td width="70%">
			<input name="coord:coord:<%= n %>" type="text" value="<%= coordinates %>" size="150">
		</td>
	</tr>
...
<% 	END IF %>
	<tr>
	    ...
	    <textarea name="coord:mods:<%= n %>" cols="130" rows="10"><%= correctiveMods %></textarea></td>
	</tr>
	<tr>
...
%>	<tr>
		...
		<td width="10%" align="right"><b>Location:</b></td>
		<td width="70%"><input name="coord:coord:0" type="text" value="" size="150"/></td>
	</tr>
	<tr>
		<td align="right" valign="top" nowrap><b>Corrective Mods:</b><!--<br />(required)--></td><td>
			<textarea name="coord:mods:0" cols="130" rows="10" ></textarea></td>
	</tr>
	<tr>
		<td colspan="3"><hr align="center" width="80%" size="1"></td>
	</tr>	
	...
	<input name="submit" type="submit" style="font-size: 20px;" value="Add More"/>
		<br><br></td></tr>
<br><br>
</form>
</body>
