...
<% If Request("list") Then
	...
	<h3>Please select image files not associated in database for removal.</h3>
...
<% Else 
	...
	SET RS0=connSWPPP.execute(SQL0)	%>
	<h3>Please select an image size needed to be listed for removal.</h3>
	<ul>
